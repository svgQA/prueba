export const columns_es = {
  ...
  h_updated_at: 'Fecha de actualización', 
  h_count: 'Recuento',
  h_created: 'Creado',
  h_created_at: 'Fecha de creación', 
  h_title: 'Título',
  h_id: 'ID',
  ...
  h_correspondence_total: 'Total de correspondencias',
  ...
  h_accesses_in_progress: 'Vehículos que ingresaron',
  h_accesses_completed: 'Vehículos que ingresaron y salieron',
  h_accesses_subtitle: 'Registros creados',
  h_accesses_entered_subtitle: 'Por día',
  h_room: 'Sala',
...
export const columns_en = {
  ...
  h_users_selected: 'Selected users with notification registration',
