export const toast_es = {
  ...
  s_replicated_success: 'Recopilado con éxito',
  ...
  s_replicated_error: 'Error al replicar',
  ...
  s_must_select: 'Debes seleccionar un elemento',
  ...
  s_must_some_selected: 'Debes seleccionar algunos elementos',
  s_url_error: 'URL Invàlida',
  s_getted_error: 'Error al obtener datos',
  s_there_are_not_player_id: 'No hay usuarios con Player ID',
  s_insert_points: 'Inserta puntos',
  s_select_date: 'Selecciona una fecha',
  s_select_template: 'Selecciona una plantilla',
  s_title_and_sub_required: 'Tìtulo y Subtìtulo son requeridos',
  ...
  s_download_file_success: 'Descargado exìtosamente',
  ...
  s_warning:
    'El turno no se puede eliminar porque ya està en curso o finalizado',
  ...
  s_tenant_created: 'Tenant creado exitosamente',
  s_instance_created: 'Instancia creada exitosamente',
...
export const toast_en = {
  ...
  s_structure_success: 'Correct structure',
  ...
  s_must_select: 'Please select an element',
  ...
  s_must_some_selected: 'Please select some elements',
  s_url_error: 'Invalid URL',
  s_getted_error: 'Error getting data',
  s_there_are_not_player_id: 'There are no users with Player ID',
