        ...
        {homeMenu === '/' && (
          <>
            <div className='flex flex-col items-center text-center'>
              ...
              /> */}
              <h1 className='text-3xl mb-3 mt-3'>Transforma la Gestión de Operaciones Con Tryvoo</h1>
              <span className='mb-5'>Optimiza la gestión de actividades, recursos y activos, incluso sin <span className='font-bold'>conectividad para tus negocios</span></span>
              <Button
            ...
            <div className='bg-white text-center'>
              ...
              <span className='text-[#28787B] pb-5'>Simplifica. Optimiza. Crece</span>
                ...
                <div className=''>
                  <div className="pl-4 pr-4 mt-5 p-4 shadow-xl max-w-md mx-auto bg-white rounded-lg space-y-4">
                    <div className="flex items-start space-x-4">
                      <img src={imageDesktopHomeAnalitics} alt="Gestión" className="w-8 h-8" />
              ...
              <div>
                ...
                <span>En Tryvoo, entendemos las complejidades de operar fuera de la oficina.</span>
              </div>

              <div>
                <span>Nuestros planes</span>
                <span>Elige el plan perfecto para tu negocio y transforma tus operaciones de campo. Comienza con Tryvoo hoy mismo!</span>
