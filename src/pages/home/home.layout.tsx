...
import weBackground from '../../assets/image/we-background.png';
...
export const HomeLayout: FunctionComponent = () => {
  ...
  const We = () => {
    return (
      <div className='flex flex-col items-center text-center bg-white pt-[70px]'>
        ...
        <span className='text-xl text-[#505050]'>En Tryvoo, entedemos las complejidades de operar fuera de la oficina.</span>

        <div className='mt-7 flex items-center justify-center'>
          <div className='w-[25%] shadow-xl bg-white rounded-lg p-[20px]'>
            <span className='text-[#707070] text-2xl ml-[20px]'>En Tryvoo trabajamos para que tu equipo en campo tenga las herramientas necesarias para lograr más, con seguridad y eficiencia, en cualquier lugar.</span>
          </div>
          <img src={homeWeCenter} alt="" className='w-[20%] h-auto' />

          <div className={`w-[25%] flex flex-col items-center justify-center bg-we text-white p-5 rounded-lg`}>
            <span className='text-2xl font-bold mt-7'>Nuestros Valores</span>
            <span className='text-lg'>“Empoderar a las empresas con herramientas para gestionar de manera eficiente sus operaciones en campo, brindando un control total de actividades, recursos y activos, mientras se garantiza la seguridad y trazabilidad en todo momento.”</span>
            <span className='text-2xl font-bold mt-7'>Nuestros Valores</span>
            <span className='text-lg mb-7'>Innovación y mejora continua Seguridad, trazabilidad y confianza Transparencia en la comunicación Compromiso con el cliente y colaboradores</span>
          </div>
        </div>
      </div>
    )
  ...
  const Plans = () => {
    return (
      <div className='flex flex-col items-center text-center bg-white text-[#28787B] pt-[70px]'>
        <span className='text-3xl font-bold text-[#20314F]'>Nuestros planes</span>
        <span className='text-xl text-[#505050]'>Elige el plan perfecto para tu negocio y transforma tus operaciones de campo. Comienza con Tryvoo hoy mismo!</span>
        ...
        <div className='flex flex-wrap gap-6 justify-center mt-7 mb-10'>
          <div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
            ...
            <div class="p-6 text-center">
              ...
              <p class="text-gray-600 text-xl mt-1">Inicio 7 días y un plan básico</p>
            </div>
              ...
              <div class="bg-[#26B6D4] text-white p-6 rounded-lg">
                <ul class="space-y-3 text-lg">
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Gestión de operaciones limitada (hasta 5 usuarios).</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Monitoreo en tiempo real para un máximo de 3 activos.</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Asistencia virtual limitada (soporte solo en horario laboral).</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Integración con una herramienta externa. Duración: 30 días de prueba gratuita. Plan Enterprise (Intermedio).</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Para empresas en crecimiento que necesitan mayor alcance.</span>
                  </li>
                </ul>
              </div>
          ...
          <div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
            ...
            <div className='bg-[#1D2B53] rounded-lg'>
              <div class="bg-[#1D2B53] text-white p-6 rounded-lg">
                <ul class="space-y-3 text-lg">
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Gestión de operaciones para hasta 50 usuarios.</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Monitoreo en tiempo real sin límite de activos.</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Funcionalidades offline completas (sincronización automática de datos).</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Asistencia con IA personalizada (soporte 24/7).</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Integración con hasta 3 herramientas externas.</span>
                  </li>
                  <li class="flex items-start">
                    ✅ <span class="ml-2 text-left">Panel de informes básicos para análisis de datos.</span>
                  </li>
                </ul>
              </div>
          ...
          <div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
            ...
            <div class="p-6">
              <ul class="space-y-3 text-lg text-gray-700">
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">Usuarios ilimitados y operaciones escalables.</span>
                </li>
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">Monitoreo avanzado con reportes en tiempo real y análisis predictivo.</span>
                </li>
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">Funcionalidades offline avanzadas (soporte para dispositivos múltiples).</span>
                </li>
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">IA avanzada con recomendaciones estratégicas y análisis de riesgos.</span>
                </li>
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">Integración ilimitada con herramientas externas.</span>
                </li>
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">Panel de informes avanzado con personalización total.</span>
                </li>
                <li class="flex items-start">
                  ✅ <span class="ml-2 text-left">Soporte prioritario 24/7 con consultor dedicado.</span>
                </li>
              </ul>
            </div>
