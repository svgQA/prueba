                  ...
                  <div class='space-y-2'>
                    ...
                    <div>
                      ...
                      <p class='text-sm text-gray-900 capitalize'>
                        {pqrs.value?.extraData?.actorType || 'N/A'}
                      </p>
                    </div>
                  ...
                  <div>
                    ...
                    <p class='text-sm text-gray-900'>
                      {pqrs.value?.extraData?.attentionDate ? (
                        <FormattedDate
                          date={String(pqrs.value?.extraData.attentionDate)}
                          format='date'
                        />
                      ) : (
                        'N/A'
                  ...
                  <div>
                    ...
                    <p class='text-sm text-gray-900'>
                      {pqrs.value?.extraData?.legalizationDate ? (
                        <FormattedDate
                          date={String(pqrs.value?.extraData.legalizationDate)}
                          format='date'
                        />
                      ) : (
                        'N/A'
              ...
              <div class='space-y-3'>
                ...
                <div class='space-y-3'>
                  ...
                  <div>
                    ...
                    <p class='text-sm text-gray-900'>
                      {pqrs.value?.extraData?.assignee || 'Sin asignar'}
                    </p>
                  </div>
                </div>
              </div>
