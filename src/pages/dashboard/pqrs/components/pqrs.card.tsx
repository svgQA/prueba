                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{pqrs.extraData.accountNumber ? `#${pqrs.extraData.accountNumber}` : ''}</p>
                            </div>
                        ...
                        {pqrs.extraData.registerObservation && (
                            <p class="text-sm text-gray-600 line-clamp-2">{pqrs.extraData.registerObservation}</p>
                        )}
                        <div class="flex flex-wrap gap-2">
                            {pqrs.extraData.filingDate && (
                                <FormattedDate date={String(pqrs.extraData.filingDate)} format='date' />
                            )}
                        ...
                        <div class="flex justify-between items-center text-xs text-gray-500">
                            ...
                            {pqrs.extraData.ticketNumber && <span class="font-mono">#{pqrs.extraData.ticketNumber}</span>}
                        </div>
                    </div>
                </Card>
            </div>
