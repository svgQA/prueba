    ...
    <div class='space-y-4'>
      <div class='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
        {pqrs.value?.extraData?.contractNumber &&
          pqrs.value?.extraData?.contractNumber !== 'N/A' && (
            <TextInformation
              label='Contrato'
        ...
        {pqrs.value?.extraData?.associatedPlan &&
          pqrs.value?.extraData?.associatedPlan !== 'N/A' && (
            <TextInformation
              label='Plan'
        ...
        {pqrs.value?.extraData?.orderNumber &&
          pqrs.value?.extraData?.orderNumber !== 'N/A' && (
            <TextInformation
              label='Orden'
        ...
        {pqrs.value?.extraData?.orderStatus &&
          pqrs.value?.extraData?.orderStatus !== 'N/A' && (
            <TextInformation
              label='Estado Orden'
              value={pqrs.value?.extraData?.orderStatus}
            />
          )}
        {pqrs.value?.extraData?.registeredBy &&
          pqrs.value?.extraData?.registeredBy !== 'N/A' && (
            <TextInformation
        ...
        {pqrs.value?.extraData?.accountNumber &&
          pqrs.value?.extraData?.accountNumber !== 'N/A' && (
            <TextInformation
        ...
        {pqrs.value?.extraData?.ticketNumber &&
          pqrs.value?.extraData?.ticketNumber !== 'N/A' && (
            <TextInformation
              label='Ticket'
        ...
        {pqrs.value?.extraData?.filingDate &&
          pqrs.value?.extraData?.filingDate !== 'N/A' && (
            <div>
              <label class='text-[11px] font-semibold text-gray-500 dark:text-b-light-dark tracking-wide uppercase'>
                Fecha de Registro
              </label>
        ...
        {pqrs.value?.extraData?.expectedAttentionDate &&
          pqrs.value?.extraData?.expectedAttentionDate !== 'N/A' && (
            <div>
              <label class='text-[11px] font-semibold text-gray-500 dark:text-b-light-dark tracking-wide uppercase'>
                Fecha Esperada
              </label>
        ...
        {pqrs.value?.extraData?.receptionChannel &&
          pqrs.value?.extraData?.receptionChannel !== 'N/A' && (
            <TextInformation
              label='Canal de Recepción'
              value={pqrs.value?.extraData?.receptionChannel}
            />
          )}
        {pqrs.value?.extraData?.assignee &&
          pqrs.value?.extraData?.assignee !== 'N/A' && (
            <TextInformation
              label='Asignado a'
