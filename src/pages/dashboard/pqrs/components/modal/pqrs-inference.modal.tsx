            ...
            <div class='space-y-3'>
                ...
                {data.prioridad && (
                    <div class='flex items-center gap-2'>
                        ...
                        <span class={`px-2 py-1 text-xs font-medium rounded capitalize ${
                            data.prioridad === 'alta' ? 'bg-red-100 text-red-800' :
                            data.prioridad === 'media' ? 'bg-yellow-100 text-yellow-800' :
                ...
                {(data.area || data.subarea) && (
                    <div class='grid grid-cols-2 gap-3'>
                        {data.area && (
                            <div>
                                <span class='text-xs font-medium text-gray-500 block mb-1'>Área:</span>
                        ...
                        {data.subarea && (
                            <div>
                                <span class='text-xs font-medium text-gray-500 block mb-1'>Subárea:</span>
                                <span class='text-sm text-gray-900 capitalize'>
                ...
                {data.banderas && Object.keys(data.banderas).length > 0 && (
                    <div class='p-3 bg-orange-50 rounded-lg'>
                        ...
                        <div class='grid grid-cols-2 gap-2 text-xs'>
                            {Object.entries(data.banderas).map(([key, value]: [string, any]) => (
