            ...
            {ots.length > 0 ? (
                <div class='space-y-5'>
                    {ots.map((ot: ICOtsRequest) => (
                        <div key={ot.id} class='space-y-3 border border-gray-border/60 dark:border-b-dark-light rounded-xl p-3 bg-white/95 dark:bg-b-dark-light/95'>
                            ...
                            <div class='grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs text-gray-text-light dark:text-b-light-dark'>
                                ...
                                <div class='flex items-center gap-2'>
                                    ...
                                    <span class='font-medium'>
                                        {ot.executionDate ? new Date(ot.executionDate).toLocaleString() : '--'}
                                    </span>
                                </div>
                            </div>
