...
export const SendForm = ({ onClose, users, hasplayers }: Props) => {
  ...
  return (
    <div
      ref={ref}
      className='bg-white dark:bg-b-dark-dark rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4'
    >
      ...
      <ManualNotificationForm users={users} hasplayers={hasplayers}  onClose={onClose}/>
    </div>
  );
};
