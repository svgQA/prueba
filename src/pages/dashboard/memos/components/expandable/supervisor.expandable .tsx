      ...
      <div className="flex flex-row gap-2">
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">SV</span>
              </div>
              <div>
                <p className="font-medium text-gray-700 text-xs">Supervisor</p>
                <p className="text-gray-600 text-xs">{memo?.extraData.company.name}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">SR</span>
              </div>
              <div>
            ...
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">LG</span>
              </div>
              <div>
                <p className="font-medium text-gray-700 text-xs">Lugar</p>
                <p className="text-gray-600 text-xs">{memo?.extraData.place.address}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-[15%]">
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">CL</span>
              </div>
              <div>
                <p className="font-medium text-gray-700 text-xs">Cliente</p>
                <p className="text-gray-600 text-xs">{memo?.extraData.client.name}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">CD</span>
              </div>
              <div>
                <p className="font-medium text-gray-700 text-xs">Ciudad</p>
                <p className="text-gray-600 text-xs">{memo?.extraData.city.name}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">CP</span>
              </div>
              <div>
            ...
            <div className="flex items-start gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">
                <span className="text-[10px] font-medium text-gray-500">DR</span>
              </div>
              <div>
