...
// // Componentes adicionales que ya tenías en este archivo
// export const ProgressBar: FunctionComponent<{ progress: number }> = ({ progress }) => (
//   <div className='flex items-center w-full'>
//     <div className='w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 mr-2'>
...
// export const InfoIcon: FunctionComponent<{ onClick: () => void; isExpanded: boolean }> = ({ onClick, isExpanded }) => (
//   <button onClick={onClick} className='p-1 rounded-full hover:bg-gray-200 transition-colors duration-200'>
//     {isExpanded ? <ChevronUp size={20} /> : <ChevronDown size={20} />}
//   </button>
// );

// export const FormattedDate: FunctionComponent<{ date: string }> = ({ date }) => {
//   const dateObj = new Date(date);
//   const day = dateObj.getDate().toString().padStart(2, '0');
//   const month = (dateObj.getMonth() + 1).toString().padStart(2, '0');
//   const year = dateObj.getFullYear();
...
// export const PriorityBadge: FunctionComponent<{ priority: 'Alta' | 'Media' | 'Baja' }> = ({ priority }) => {
//   const bgColor =
//     priority === 'Alta'
//       ? 'rgb(224,88,88)'
//       : priority === 'Media'
...
//   return (
//     <div className='flex items-center justify-center py-1 rounded text-white text-sm w-[90px]' style={{ backgroundColor: bgColor }}>
//       <Shield className='mr-2' size={20} />
//       <span>{priority}</span>
//     </div>
//   );
...
//     header: 'Nombre',
//   },
//   // Nueva columna Ciudad entre "Nombre" y "Tipo Novedad"
//   {
//     accessorKey: 'city',
//     header: 'Ciudad',
//   },
