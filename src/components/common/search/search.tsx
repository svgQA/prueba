...
export const Search = ({
  ...
  return (
    <div
      id={id}
      className='flex flex-row items-center h-12 w-full max-w-[850px] px-3 border-2 rounded-xl relative dark:border-b-dark-light border-b-light-dark shadow-sm focus-within:ring-2 focus-within:ring-primary-opacity focus-within:border-primary transition-all duration-200'
    >
