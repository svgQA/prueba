...
export const ExpandeableContent = ({
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            <div className='flex flex-row bg-white dark:bg-b-dark-dark'>{children}</div>
            {/* Footer */}
            {footer && (
                <div className='flex flex-row w-full justify-end gap-2 bg-white dark:bg-b-dark-dark'>{footer}</div>
            )}
        </div>
    );
};
